(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('os'), require('chalk'), require('child_process'), require('path'), require('app-path'), require('shelljs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'os', 'chalk', 'child_process', 'path', 'app-path', 'shelljs'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.index = {}, global.os, global.chalk, global.child_process, global.path, global['app-path'], global.shelljs));
}(this, (function (exports, os, chalk, child_process, path, appPath, shelljs) { 'use strict';
